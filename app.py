...
if selected == "Home":
    st.title("Welcome To MoveMaster App ")
    st.image("logoddp.jpg")
    
elif selected == "About":
    st.title("About MoveMaster APP")
    st.image("logoddp.jpg")
    st.write("What is MoveMaster app?")
    st.write("MoveMaster App kami rancang untuk memudahkan orang-orang dalam menentukan estimasi waktu, kecepatan maupun jarak yang akan kita tempuh. ")
    ...
    st.title("Aplikasi Perhitungan Jarak, Waktu dan Kecepatan Motor")
    st.image("motor.jpg")
